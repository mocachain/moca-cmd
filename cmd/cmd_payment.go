...
Examples:
$ moca-cmd payment buy-quota  --chargedQuota 1000000  moca://bucket-name`,
		Flags: []cli.Flag{
			&cli.Uint64Flag{
...
Examples:
$ moca -c config.toml payment quota-info  moca://bucket-name`,
	}
}
...
// getQuotaInfo query the quota price info of sp from moca chain
