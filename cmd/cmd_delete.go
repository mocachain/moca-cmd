...
func cmdDelBucket() *cli.Command {
	return &cli.Command{
		...
		Description: `
Send a deleteBucket txn to moca chain, the bucket must be empty before deleting

Examples:
# Delete an existed bucket called moca-bucket
$ moca-cmd bucket rm moca://moca-bucket/moca-object`,
	}
}
...
func cmdDelObject() *cli.Command {
	return &cli.Command{
		...
		Description: `
Send a deleteObject txn to moca chain

Examples:
# Delete an existed object called moca-object
$ moca-cmd object rm moca://moca-bucket/moca-object`,
		Flags: []cli.Flag{
			&cli.BoolFlag{
				Name:  recursiveFlag,
				Value: false,
...
func cmdDelGroup() *cli.Command {
	return &cli.Command{
		...
		Description: `
Send a deleteGroup txn to moca chain

Examples:
# Delete an existed group
$ moca-cmd group rm group-name`,
	}
}

// deleteBucket send the deleteBucket msg to moca
...
// deleteObject send the deleteBucket msg to moca
...
// deleteGroup send the deleteGroup msg to moca
