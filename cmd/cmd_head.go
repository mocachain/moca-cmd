...
func cmdHeadObj() *cli.Command {
	return &cli.Command{
		...
		Description: `
send headObject txn to chain and fetch object info on moca chain
Examples:
$ moca-cmd object head moca://bucket-name/object-name`,
		Flags: []cli.Flag{
			&cli.GenericFlag{
				Name:    formatFlag,
				Aliases: []string{"f"},
...
func cmdHeadBucket() *cli.Command {
	return &cli.Command{
		...
		Description: `
send headBucket txn to chain and fetch bucket info on moca chain
Examples:
$ moca-cmd bucket head moca://bucket-name`,
		Flags: []cli.Flag{
			&cli.GenericFlag{
				Name:    formatFlag,
				Aliases: []string{"f"},
...
func cmdHeadGroup() *cli.Command {
	return &cli.Command{
		...
		Description: `
send headGroup txn to chain and fetch bucketInfo on moca chain
Examples:
$ moca-cmd group head --groupOwner  group-name`,
		Flags: []cli.Flag{
			&cli.StringFlag{
				Name:  groupOwnerFlag,
				Value: "",
...
Examples:
$ moca-cmd head-member 0xF678C3734F0EcDCC56cDE2df2604AC1f8477D55d  group-name`,
		Flags: []cli.Flag{
			&cli.StringFlag{
				Name:  groupOwnerFlag,
				Value: "",
