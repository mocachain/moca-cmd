...
If no keyfile is specified by --keystore or -k flag, a keystore will be generated at the default path (homedir/.moca-cmd/keystore/key.json)
...
Examples:
$ moca-cmd bank balance --address 0x... `,
		Flags: []cli.Flag{
			&cli.StringFlag{
				Name:  addressFlag,
				Value: "",
...
Examples:
$ moca-cmd account default  0x75345BC9FfFAe09486dE7EC954bAfAEcE29b9b24`,
	}
}
...
Examples:
# Create a transfer
$ moca-cmd bank transfer --toAddress 0x.. --amount 12345`,
		Flags: []cli.Flag{
			&cli.StringFlag{
				Name:     toAddressFlag,
				Value:    "",
...
func createAccount(ctx *cli.Context) error {
	...
	account, privateKey, err := sdktypes.NewAccount("moca-account")
	if err != nil {
		return toCmdErr(err)
	}
